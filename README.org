...
The main repository is on [[https://codeberg.org/Kyuvi/ez-map][Codeberg.org]], if you are viewing this anywhere else, this is just a mirror, please use the [[https://codeberg.org/Kyuvi/ez-map][Codeberg.org]] repository for pull requests and issues
